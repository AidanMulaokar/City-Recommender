...
def main():
    ...
    # race = ["White", "Black", "American/Alaskan Native",
    #         "Asian", "Pacific Islander/ Hawaiian Native", "Multiracial", "Hispanic", "Other"]
    # marital = ["Married", "Unmarried"]
    # employment = ["Student", "Self-Employed", "Employed", "Unemployed"]
    # income = [" < 35000", "$35, 000 - $75, 000", "> 75000"]
    # education = ["", "High School / GED", "", ""]
    # for i in range(20):
    #     algo(
    #         {
    #             "city_pop": random.randint(0, 10),
    #             "city_median_age": random.randint(0, 10),
    #             "city_property_value": random.randint(0, 10),
    #             "city_household_income": random.randint(0, 10),
    #             "city_household_ownership": random.randint(0, 10),
    #             "city_biz_tech": random.randint(0, 10),
    #             "city_universities": random.randint(0, 10),
    #             "city_diversity": random.randint(0, 10),
    #             "city_gender_wage_gap": random.randint(0, 10),
    #             "city_avg_wage_gap": random.randint(0, 10),
    #             "city_public_transit": random.randint(0, 10),
    #             "city_walk_bike": random.randint(0, 10),
    #             "city_wfh": random.randint(0, 10),
    #             "city_exercise": random.randint(0, 10),
    #             "city_crime": random.randint(0, 10),
    #             "city_political": random.randint(0, 10),
    #             "user_political": political[random.randint(0, 1)],
    #             "age": random.randint(18, 40),
    #             "gender": gender[random.randint(0, 1)],
    #             "race": race[random.randint(0, 7)],
    #             "marital": marital[random.randint(0, 1)],
    #             "children": random.randint(0, 6),
    #             "education": education[random.randint(0, 3)],
    #             "employment": employment[random.randint(0, 3)],
    #             "income": income[random.randint(0, 2)]
    #         }
    #     )
    ...
    for i in range(len(output.values())):
        if list(output.values())[i] > max:
            max = list(output.values())[i]
    quartiles = []
    quartiles.append(max * 0.25)
    quartiles.append(max * 0.5)
    quartiles.append(max * 0.75)
    quartiles.append(max)
    with open('results.json', 'w') as outfile:
        json.dump({"results": output, "quartiles": quartiles}, outfile)
